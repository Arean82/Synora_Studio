...
def translate_po_files():
    ...
    for po_file_path in po_files:
        # Extract language code from path (e.g. web/locales/es/LC_MESSAGES/messages.po -> es)
...
def translate_readmes():
    ...
    saas_docs_dir = os.path.join(project_root, 'web', 'saas_docs')
