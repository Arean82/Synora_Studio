...
ExecStart=/path/to/Synora_Studio/venv/bin/python synora_synora_server/synora_server.py
Restart=always
RestartSec=3
...
```bash
pyinstaller --noconfirm --onedir --name "Synora_Server" synora_synora_server/synora_server.py
```
...
- **Linux:** `ALLOW_UNAUTHENTICATED_SERVER="1" python synora_synora_server/synora_server.py`
