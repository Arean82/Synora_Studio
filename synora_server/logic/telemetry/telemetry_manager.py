# synora_server/logic/telemetry/telemetry_manager.py
...
import logging
import threading
from synora_server.logic.services.base_service import BaseService, ServiceRegistry
...
class TelemetryManager(BaseService):
    ...
    def __init__(self):
        ...
        self.telemetry_log_path = StorageManager.get_instance().get_storage_root() / "synora_server" / "data" / "telemetry_logs.jsonl"
