# synora_server/logic/chat_worker.py
...
class ChatWorker(QThread):
                ...
                try:
                    ...
                    if query_vector:
                        ...
                        if top_5:
                            ...
                            try:
                                from synora_server.logic.graph_rag import GraphManager
    ...
    def _run_openai_loop(self):
        ...
        from synora_server.utils.model_config import does_model_support_tools, update_model_capability
            ...
            if self.stream:
                try:
                    ...
                    if model_supports_tools and ("tool" in err_str or "auto" in err_str or "badrequesterror" in err_str or "400" in err_str or "not support" in err_str):
                        ...
                        from synora_server.utils.model_config import update_model_capability
                        update_model_capability(self.client.current_model, False)
