...
"""
Turso/libSQL Tenant Driver
Extracted from the original synora_saas/tenant_db.py TenantDatabaseManager.
...
from synora_server.logic.tenant.drivers.base_tenant_driver import BaseTenantDriver
...
class TursoTenantDriver(BaseTenantDriver):
    ...
    def __init__(self, db_name="saas_tenants.db"):
        ...
        self.db_path = storage_root / "synora_server" / "data" / db_name
