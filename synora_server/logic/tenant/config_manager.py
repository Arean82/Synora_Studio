...
Enables headless server admins to directly edit synora_saas/config.ini with ease.
"""
...
class SaaSConfigManager:
    ...
    def __init__(self):
        ...
        # For strict modularity, we persist this inside the server module boundary.
        self.config_path = StorageManager.get_instance().get_storage_root() / "synora_server" / "data" / "config.ini"
